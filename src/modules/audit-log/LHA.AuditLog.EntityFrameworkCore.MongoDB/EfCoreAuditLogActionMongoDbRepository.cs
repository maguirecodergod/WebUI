...
/// <summary>
/// MongoDB implementation of <see cref="IAuditLogActionRepository"/>.
/// </summary>
public class EfCoreAuditLogActionMongoDbRepository
    : EfCoreRepository<AuditLogDbContext, AuditLogActionEntity, Guid>, IAuditLogActionRepository
{
    public EfCoreAuditLogActionMongoDbRepository(IDbContextProvider<AuditLogDbContext> dbContextProvider)
