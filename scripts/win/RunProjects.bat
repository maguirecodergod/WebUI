...
@REM goto menu
:run_no_build
wt -w 0 nt --title "ApiGateway" cmd /k "cd /d %~dp0..\..\src\gateways\LHA.ApiGateway && dotnet run --no-build"; nt --title "Account.API" cmd /k "cd /d %~dp0..\..\src\services\account\LHA.Account.HttpApi.Host && dotnet run --no-build"; nt --title "Notification.API" cmd /k "cd /d %~dp0..\..\src\services\notifications\LHA.Notification.HttpApi.Host && dotnet run --no-build"; nt --title "Account.Consumer" cmd /k "cd /d %~dp0..\..\src\services\account\LHA.Account.Consumer && dotnet run --no-build"; nt --title "Notification.Consumer" cmd /k "cd /d %~dp0..\..\src\services\notifications\LHA.Notification.Consumer && dotnet run --no-build"; nt --title "Account.Cron" cmd /k "cd /d %~dp0..\..\src\services\account\LHA.Account.Cron && dotnet run --no-build"; nt --title "Notification.Cron" cmd /k "cd /d %~dp0..\..\src\services\notifications\LHA.Notification.Cron && dotnet run --no-build"
pause
goto menu
